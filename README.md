...
$project['Места']    = [
    '1' => [
        'Смысл'    => 'Описание 1',
        'Роль'     => ['Субъект роли 1'=>['Объект роли 1'=>'Конструкция роли 1']],
        'Связь'    => 'Наличие связи 1',
        'Реакция'  => 'Наличие реакции 1',
        'Вложение' => [
            '1.1' => [
                'Смысл'    => 'Описание 2',
                'Роль'     => ['Субъект роли 2'=>['Объект роли 2'=>'Конструкция роли 2']],
                'Связь'    => 'Наличие связи 2',
                'Реакция'  => 'Наличие реакции 2',
                'Вложение' => [
                    '1.1.1' => [
                        'Смысл'    => 'Описание 3',
                        'Роль'     => ['Субъект роли 3'=>['Объект роли 3'=>'Конструкция роли 3']],
                    ...
                    '1.1.2' => [
                        'Смысл'    => 'Описание 4',
                        'Роль'     => ['Субъект роли 4'=>['Объект роли 4'=>'Конструкция роли 4']],
...
Обозначаются роли: {субъектом}, {объектом} и {конструкцией}.

**Субъект роли** нужен для первого направления проектирования:
1. Хранение
> форма вмещения
> 
...
**Объект роли** нужен для второго направления проектирования. Статичный список скоро будет составлен.

**Конструкция роли** итог направлений. У роли может быть несколько конструкций.
