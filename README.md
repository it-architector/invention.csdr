...
> 
> Конструкция: array('инкапсуляция'=>array('инкапсуляция'=>['значение 1','оператор','значение 2'],'инкапсуляция'=>['значение 1','оператор','значение 2']))
> 
> Где, инкапсуляция: 
...
$project['Места']    = [
    '1' => [
        'Смысл'    => 'Описание 1',
        'Роль'     => ['Тип роли 1'=>'Значение роли 1'],
        'Связь'    => 'Наличие связи 1',
        'Вложение' => [
            '1.1' => [
                'Смысл'    => 'Описание 2',
                'Роль'     => ['Тип роли 2'=>'Значение роли 2'],
                'Связь'    => 'Наличие связи 2',
                'Вложение' => [
                    '1.1.1' => [
                        'Смысл'    => 'Описание 3',
                        'Роль'     => ['Тип роли 3'=>'Значение роли 3'],
                        'Связь'    => 'Наличие связи 3',
                        'Вложение' => false,
                     ],
                    '1.1.2' => [
                        'Смысл'    => 'Описание 4',
                        'Роль'     => ['Тип роли 4'=>'Значение роли 4'],
...
> Где, в роль можно добавить: 
> 1. Тип роли: инкапсуляция, атрибут, запрос, ожидание
> 2. Значение роли: смотрите варианты в <a href="#Роли">роли ядра</a> и <a href="#Роли-1">роли интерфейса</a>
> 
> При этом, каждая роль создаёт различную среду для вложения места, рефлекса, связи и реакции (смотрите роли ядра и интерфейса).
...
Результат: <a href="./Образцы/Взаимодействие.php">Код взаимодействия</a> (<a href="https://framework-csdr.ru/samples/Образцы/Взаимодействие.php?x=2&y=6">запустить вариант 2 + 6</a>).

<h3>Многопоточность</h3>

Ход работы: На вход дадим массив из вариантов "x" и "y" и последовательно выведем результат в ответ.

Результат: <a href="./Образцы/Многопоточность.php">Код многопоточности</a> (<a href="https://framework-csdr.ru/samples/Образцы/Многопоточность.php?data_x_y[1][x]=3&data_x_y[1][y]=7&data_x_y[2][x]=12&data_x_y[2][y]=5&data_x_y[3][x]=6&data_x_y[3][y]=6">запустить вариант (3 + 7, 12 + 5, 6 + 6)</a>).

<h3>Вариантность</h3>

Ход работы: На вход дадим переменную "kill" и в зависимости от её значения дадим ответ.

Результат: <a href="./Образцы/Вариантность.php">Код вариантности</a> (<a href="https://framework-csdr.ru/samples/Образцы/Вариантность.php?kill=false">запустить вариант kill=false</a>, <a href="https://framework-csdr.ru/samples/Образцы/Вариантность.php?kill=true">вариант kill=true</a>).
...
Результат: <a href="./Образцы/Контроль.html">Код контроля</a> (<a href="https://framework-csdr.ru/samples/Образцы/Контроль.html">открыть на хостинге</a>).
...
Результат: <a href="./Образцы/Многопоточность.html">Код многопоточности</a> (<a href="https://framework-csdr.ru/samples/Образцы/Многопоточность.html">открыть на хостинге</a>).

<h3>Вариантность</h3>

Ход работы: Выведем ссылки меню и в зависимости от "id" из браузера активируем открытую ссылку из меню.

Результат: <a href="./Образцы/Вариантность.html">Код вариантности</a> (<a href="https://framework-csdr.ru/samples/Образцы/Вариантность.html">открыть на хостинге</a>).
...
Результат: <a href="./Образцы/Навигация.html">Код навигации</a> (<a href="https://framework-csdr.ru/samples/Образцы/Навигация.html">открыть на хостинге</a>).
...
![](./Картинки/Пополнить%20баланс.png) <a href="./Инвесторам.md">Инвесторам для создания графического Framework</a>
