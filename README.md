...
Применяя CSDR порядок (**Conditions, Space, Distribution и Realization**) можно быть уверенным, что код вашего замысла будет конструктивным (вам это знакомо как модули) и применим в любом языке программирования.
...
Роли это конструкции кода с проработанным api (вам это знакомо как модуль). 
...
Для начального кодирования введём роль **процессор** с такими конструкциями:
