...
Применяя **CSDR** (Conditions, Space, Distribution и Realization) в программировании проекта можно быть уверенным, что код проекта будет структурным.
...
> Каждый вложенный рефлекс будет автоматически активирован.
...
Роли это готовые проекты созданные структурой CSDR. Вам это знакомо как модули с проработанным api. Название роли должно содержать в себе: класификатор, объект, команду.
