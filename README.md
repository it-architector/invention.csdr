...
Применяя CSDR порядок (**Conditions, Space, Distribution и Realization**) вы будете уверены в том, что проекты будут модульными, код будет конструктивным, а применение языка программирования любым.
