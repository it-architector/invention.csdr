...
Применяя CSDR порядок (**Conditions, Space, Distribution и Realization**) вы можете быть уверены, что код будет конструктивным и применим для любого языка программирования.
