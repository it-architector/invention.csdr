...
Применяя CSDR порядок (**Conditions, Space, Distribution и Realization**) можно быть уверенным, что код вашего замысла будет конструктивным (вам это знакомо как модульность) и применим в любом языке программирования.
...
В местах кода можно выполнить определенную роли, обозначив: {название замысла},  {направление конструкции} и {назначение конструкции}. При этом, в роли можно выполнить конструкцию этой же роли, обозначив {название замысла = @this}.
