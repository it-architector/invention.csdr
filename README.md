...
Команда роли предназначена для классификации роли. У роли может быть несколько команд, где каждой команды нужно определить в компонентах такое размещение:
...
При разработке проекта код необходимых роли нужно размещать в 1-й реакции в отмеченном месте.
...
Изначально разработаны роли с процедурным кодом:
