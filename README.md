...
У каждого компонента (кроме замысла) записи должны быть последовательно пронумерованы. 
...
Чтобы каждый компонент смог раскрыть себя полностью и быть применим на любом уровне кода, было выявлено необходимое содержание:
...
Для <b>конструкций</b>:
1. Направление, где <a href="#Направление">цель конструкции из списка</a>
...
Роль это готовый код, который может быть запущен процессором, расширяя его функционал.

Для вызова роли, нужно обозначить: {название замысла},  {направление конструкции} и {назначение конструкции}.
