...
4. Условия, где id рефлексов (согласно вложению) принадлежащих данной конструкции
...
2. что, где 
     ...
     2.1 массив: {псевдоним N} = {id места N / значение} (+-вложение)
    
     2.2 {id места / значение} (+-вложение)
...
<h2>Требует разработки</h2>

1. Сформировать расчёты из свободного текстового варианта в символически-выборный
2. Хронология технологий (иерархичная)
3. Символизм данных между порядком и средой
4. Сценарий функционала процессора
