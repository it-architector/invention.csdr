...
2. Процессор, где главный модуль который выполнит модули (вам это знакомо как микросервис)
...
1. Выбор известной технологии из списка:
    1. Процессор
    2. HTTP (это релиз, исправить)
    3. Браузер
    4. Файловая система
    5. База данных
    6. Mem cached (это релиз, исправить)
    7. Web socket (это релиз, исправить)
    8. 1C (это релиз, исправить)
2. Назвать модуль (вам это знакомо как релиз)
3. Создать необходимые конструкции
