...
5. **[по запросу: информация о реакции] [входящее: {id реакции}]** получение {тип реакции} в проекте
...
12. **[по запросу: активация рефлекса] [входящее: {id рефлекса}]** запрос "информация о рефлексе" по {id рефлекса}
   ...
   3. **[есть права] [цикл]** последовательно запрашиваем "информация о месте" у мест из {сценарий ролей}
      ...
      2. **[есть связь]** запрос "информация о связи"
         1. **[есть тип внешнее в место]** запрос "передача информации с внешнего источника в места"
            1. запрашиваем "проверка прав у ожидающих рефлексов"
   ...
   3. **[цикл]** последовательно запрашиваем "активация рефлекса" с id во вложении
13. **[по запросу: проверка прав у ожидающих рефлексов]** запрос "память ожидания прав: получить всё"
   1. **[есть массив ожидания прав] [цикл]** последовательно запрашиваем "проверка прав"
       1. **[есть права]** запрашиваем "активация рефлекса" с id ожидающего рефлекса
14. запрашиваем "активация рефлекса" с id = 1 
