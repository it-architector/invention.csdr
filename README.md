...
2. <a href="#Код">Код</a>
    ...
    2.1. <a href="#Язык-программирования">Язык программирования</a>

    2.2. <a href="#Массив">Массив</a>
    
    2.3. <a href="#Проект">Проект</a>
    
    2.4. <a href="#Конструкции">Конструкции</a>
    
    2.5. <a href="#Рефлексы">Рефлексы</a>
    
    2.6. <a href="#Места">Места</a>
    
    2.7. <a href="#Связи">Связи</a>
    
    2.8. <a href="#Реакции">Реакции</a>
    
    2.9. <a href="#Процессор">Процессор</a>
