...
2. Главный модуль процессор, где функционал который выполнит модули (вам это знакомо как микросервисы)
...
Для <b>замысла</b>:
1. Название
2. Описание, где сводные данные для кодеров
3. Версия, где номер последней корректировки
...
Для первоначального создания модулей введём модуль **@cpu** с такими конструкциями:
