...
В программировании проекта, применяя **изобретение CSDR** (Conditions, Space, Distribution и Realization), можно быть уверенным, что код Вашего проекта будет  прослеживаемым, читаемым, сопровождаемым, применяемым в других проектах и расширяемым для любого уровня программиста и компетенции.
...
$project['Места']    = [
    '1' => [
        'Смысл'    => 'Описание 1',
        'Роль'     => ['Класификатор роли 1'=>['Объект роли 1'=>'Команда роли 1']],
        'Связь'    => 'Наличие связи 1',
        'Вложение' => [
            '1.1' => [
                'Смысл'    => 'Описание 2',
                'Роль'     => ['Класификатор роли 2'=>['Объект роли 2'=>'Команда роли 2']],
                'Связь'    => 'Наличие связи 2',
                'Вложение' => [
                    '1.1.1' => [
                        'Смысл'    => 'Описание 3',
                        'Роль'     => ['Класификатор роли 3'=>['Объект роли 3'=>'Команда роли 3']],
                        'Связь'    => 'Наличие связи 3',
                        'Вложение' => false,
                     ],
                    '1.1.2' => [
                        'Смысл'    => 'Описание 4',
                        'Роль'     => ['Класификатор роли 4'=>['Объект роли 4'=>'Команда роли 4']],
...
Роли это готовые проекты созданные по изобретению CSDR. Вам это знакомо как модули с проработанным api. Название роли должно содержать в себе: класификатор, объект, команду.
...
Объект и команда в названии роли пишется вручную. При этом команд можно сделать несколько.

Для каждой команды роли нужно определить размещение в компонентах:

1. Расположение в сценарии:
   1. Нет
   2. Есть, без вложения
   3. Есть, со вложением
...
Размещать роли, которые будут использоваться в проекте нужно будет в 1-й реакции в отмеченном месте.
