...
2. <a href="#Процессор">Процессор</a>
    ...
    2.2. <a href="#Функция">Функция</a>

3. <a href="#Код">Код</a>

    3.1. <a href="#Исходник">Исходник</a>
    
    3.2. <a href="#Запуск">Запуск</a>
...
Выполнять вышеописанный цикл будет функция процессора.
...
Для запуска кода нужно передать исходник кода в процессор:
