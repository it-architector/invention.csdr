...
Роли это конструкции готовых кодов (вам это знакомо как модули). 

В местах кода можно выполнить определенную роль, обозначив: {название замысла},  {направление конструкции} и {назначение конструкции}. При этом, в роли можно выполнить конструкцию этой же роли, обозначив {название замысла = @this}.
