...
1. **[по запросу: память ожидания прав] [входящее: {запрос = добавить, проверить, удалить, получить всё}, {id рефлекса}]** добавление {id рефлекса}, {алгоритм права} / проверить / получение / удаление в массиве "ожидания прав" у процессора
...
13. запрос "*активация рефлекса*" с id = 1 
