...
При этом код программируется последовательными типизированными шагами, что позволяет нескольким программистам одновременно работать над ним (по разным задачам) исключая конфликты "стиля программирования" на 100%.
