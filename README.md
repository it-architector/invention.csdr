...
Для <b>связей</b>:
1. Тип, где дальность связи / локальный, внешний
...
> Где, тип можно задать локальной и внешней. 
 
> Где, в возможности импорт значений переменных. 
>
...
> Где, в $opportunities будут начальные данные. 
> 
> Где, в return добавит информацию в результативные данные. 
...
3. Вычисление: свободное
> благодаря которой проект сможет выполнять логику
4. Контроль: запросов: получение, передача
> благодаря которой проект сможет взаимодействовать
