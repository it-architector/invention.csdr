...
2. <a href="#Модули">Модули</a>
    ...
    2.10. <a href="#Примение">Примение</a>
    
    2.11. <a href="#Создание">Создание</a>
    
    2.12. <a href="#Выполнение">Выполнение</a>
...
Для <b>связей</b>:
1. <a href="#Возможности">Возможности</a>


Для <b>реакций</b>:
1. Способность, где функция с алгоритмом
2. Ожидание, где api для взаимодействия с функцией
3. Ответ, где api ответа от функции
...
1. куда, где id места
2. что, где 
    1.1 массив: псевдоним 1 = значение id места (+-вложение) 1, псевдоним 2 = значение id места (+-вложение) 2
