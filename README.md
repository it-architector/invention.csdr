...
4. Контакт
- позволяет для мест: связи
- ожидание: {переменные откуда в куда}
- ответ: нет
5. Автозапуск
- не применим для использования в местах
- запускается вначале при каждом запуске других конструкций
- ожидание: нет
- ответ: нет
6. Автозавершение
- не применим для использования в местах
- запускается после отработки конструкций
