...
2. <a href="#Процессор">Процессор</a>
    ...
    2.3. <a href="#Функционал">Функционал</a>
    
    2.4. <a href="#Роли">Роли</a>
...
Проект начинается со своего названия и перечисления необходимых конструкций (вам это знакомо из MVC как model). Собственно это всё, что нужно ожидать от заказчика.
...
У каждого компонента (кроме проекта) записи должны быть последовательно пронумерованы. 
...
Чтобы каждый компонент смог раскрыть себя полностью и быть применим на любом уровне проекта, было выявлено необходимое содержание:
...
Для <b>конструкций</b>:
1. Направление, где главная цель из списка
2. Назначение, где пожелание в проекте
3. Предпочтение, где пожелание от данной конструкции
4. Условия, где id рефлексов принадлежащих данной конструкции
...
3. Сценарий, где id мест принадлежащих данной рефлексии
...
2. Роль, где обозначение <a href="#Роли">применённой роли из списка</a>
3. Связь, где id связи принадлежащей данному месту
4. Реакция, где id реакции принадлежащей данному месту
5. Ресурс, где id ресурса принадлежащего данному месту
...
Роль необходима для расширения функционала процессора. Создаётся роль как и CSDR код, который нужно будет добавить в список ролей в массиве процессора. 

Для применении в коде обозначаются: {названием проекта},  {направлением конструкции} и {названачением конструкции}.
...
> Где, направление для концентрированного проектирования конструкции и состоит из 4-х вариантов:
1. Хранение
> форма вмещения
> 
