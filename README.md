...
3. <a href="#Код">Код</a>
    ...
    3.9. <a href="#Процессор">Процессор</a>
    
    3.10. <a href="#Выполнение">Выполнение</a>
    
4. <a href="#Прототип-проектов-на-PHP">Прототип проектов на PHP</a>

    4.1. <a href="#Роли-1">Роли</a>
    
    4.2. <a href="#Взаимодействие">Взаимодействие</a>
    
    4.3. <a href="#Многопоточность">Многопоточность</a>
    
    4.4. <a href="#Вариантность">Вариантность</a>
    
5. <a href="#Прототип-проектов-на-JS">Прототип проектов на JS</a>

    5.1. <a href="#Роли-2">Роли</a>
    
    5.2. <a href="#Контроль">Контроль</a>
    
    5.3. <a href="#Многопоточность-1">Многопоточность</a>
    
    5.4. <a href="#Вариантность-1">Вариантность</a>
    
    5.5. <a href="#Навигация">Навигация</a>
    
    5.6. <a href="#реакция-pagespeed">Реакция pagespeed</a>
...
Роль это реализованный CSDR код, который будет дополнять функционал процессора. Обозначаются роли: {названием проекта},  {ориантировкой конструкции} и {конструкцией проекта}.
...
Для выполнения кода нужно запустить процессор с параметрами:

```php
$cpu['Версии']['{Версия процессора}']($in = ['{код = $code}','{конструкция = "фоновый запуск"}','{параметры конструкции = ["сделать" => "оптимизацию базы"]}']);
```
