...
Применяя CSDR порядок (**Conditions, Space, Distribution и Realization**) вы будете уверены в том, что код будет модульными и конструктивным, а применение языка программирования любым.
