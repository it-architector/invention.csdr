...
Роли это готовые проекты созданные по изобретению CSDR. Вам это знакомо как модули с проработанным api. Название роли должно содержать в себе: класификатор, объект, вызов.
