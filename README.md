...
Применяя CSDR порядок (**Conditions, Space, Distribution и Realization**) вы будете уверены в том, что код будет конструктивным и применим для любого языка программирования.
