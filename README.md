...
1. <a href="#Проект">Проект</a>
    ...
    1.6. <a href="#Процессор">Процессор</a>
...
Чтобы запустить данный процесс, будет отдельная функция, которая находится в репозитории <a href="https://github.com/it-architector/cpu.csdr">cpu.csdr</a>.
...
Роли это готовые проекты, созданные согласно коду CSDR. Вам это знакомо как модули с проработанным api. Более подробно в репозитории <a href="https://github.com/it-architector/roles.csdr">roles.csdr</a>.
