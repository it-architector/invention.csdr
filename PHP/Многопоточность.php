...
$GLOBALS['Рефлексы'] = [
    '1' => [
        ...
        'Расчёты'    => 'Входящие данные из массива ("x" и "y") создают масив значений "z"',
        'Сценарий'   => [
            ['place_1.2' => ['reflex_1.1']]
        ],
        'Права'      => 'true',
        'Вложение'   => [
            '1.1' => [
                'Ориентир'   => 'Образец многопоточного решения',
                'Расчёты'    => 'Решить формулу z = x + y, для каждого x и y',
                'Сценарий'   => [
                    ['place_1.2.2' => ['place_1.2.2.3','place_1.2.2.5']]
                ],
                'Права'      => [
                    ['{1.2.1}','!=',null]
                ],
    ...
    '1' => [
        ...
        'Вложение' => [
            ...
            '1.2' => [
                ...
                'Вложение' => [
                    '1.2.1' => [
                        'Смысл'    => 'Массив из x и y',
                        'Роль'     => ['Атрибут'=>'information'],
                        'Связь'    => false,
                        'Вложение' => null
                    ],
                    '1.2.2' => [
                        'Смысл'    => 'Распределение массива x и y',
...
$GLOBALS['Связи']    = [
    ...
    '2'  => [
        'Тип'                 => 'Глобальное',
        'Возможности'         => ['data_x_y'=>'1.2.1'],
        'Приобретение'        => ['1.2.3'=>'data_z'],
        'Образец возможностей' => [
            'data_x_y' => [
                ['x'=>2, 'y'=>3],
                ['x'=>5, 'y'=>5],
    ...
    '3'  => [
        'Тип'                 => 'Локальное',
        'Возможности'         => ['1.2.1'=>'array'],
        'Приобретение'        => ['x'=>'1.2.2.1','y'=>'1.2.2.2'],
        'Образец возможностей' => [
            'array' => [
                ['x'=>2, 'y'=>3],
                ['x'=>5, 'y'=>5]
    ...
    '4'  => [
        'Тип'                 => 'Локальное',
        'Возможности'         => ['1.2.2.1'=>'x','1.2.2.2'=>'y'],
        'Приобретение'        => ['z'=>'1.2.2.1'],
        'Образец возможностей' => [
            'x'=>2,
            'y'=>3
        ],
    ...
    '5'  => [
        'Тип'                 => 'Локальное',
        'Возможности'          => ['1.2.3'=>'all_z','1.2.2.1'=>'one_z'],
        'Приобретение'         => ['all_z'=>'1.2.3'],
        'Образец возможностей' => [
            'all_z' => [],
            'one_z' => '3'
        ],
...
$GLOBALS['Реакции']  = [
    ...
    '3'  => [
        'Способность'  => function($opportunities = []){
            ...
            $opportunities['all_z'][] = $opportunities['one_z'];

            /*результат*/
            return [
                'all_z' => $opportunities['all_z'],
            ];
        }
    ],
];
