...
$GLOBALS['Рефлексы'] = [
    '1' => [
        'Ориентир'   => 'Ядро (образец вариантности)',
        'Расчёты'    => 'Принять внешний "kill", составить по нему предложение и отдать в ответ',
        'Сценарий'   => [
            ['place_1.2'=>['reflex_1.1','reflex_1.2']]
        ],
        'Права'      => 'true',
        'Вложение'   => [
            '1.1' => [
                'Ориентир'   => 'Помилование',
                'Расчёты'    => 'Казнить нельзя, помиловать.',
                'Сценарий'   => ['place_1.2.2.6','place_1.2.2.7','place_1.2.2.9','place_1.2.2.8'],
                'Права'      => [
                    ['{1.2.1}','=','false']
                ],
                'Вложение'   => false
            ...
            '1.2' => [
                'Ориентир'   => 'Убийство',
                'Расчёты'    => 'Казнить, нельзя помиловать.',
                'Сценарий'   => ['place_1.2.2.6','place_1.2.2.9','place_1.2.2.7','place_1.2.2.8'],
                'Права'      => [
                    ['{1.2.1}','=','true']
                ],
                'Вложение'   => false
                ...
                'Вложение' => [
                    ...
                    '1.2.2' => [
                        ...
                        'Вложение' => [
                            ...
                            '1.2.2.6' => [
                                'Смысл'    => 'Вставить в предложение слово 1',
                                'Роль'     => ['Запрос'=>'reaction'],
                                'Связь'    => '3',
                                'Вложение' => false
                            ],
                            '1.2.2.7' => [
                                'Смысл'    => 'Вставить в предложение слово 2',
                                'Роль'     => ['Запрос'=>'reaction'],
                                'Связь'    => '4',
                                'Вложение' => false
                            ],
                            '1.2.2.8' => [
                                'Смысл'    => 'Вставить в предложение слово 3',
                                'Роль'     => ['Запрос'=>'reaction'],
                                'Связь'    => '5',
                                'Вложение' => false
                            ],
                            '1.2.2.9' => [
                                'Смысл'    => 'Вставить в предложение разделитель',
                                'Роль'     => ['Запрос'=>'reaction'],
                                'Связь'    => '6',
                                'Вложение' => false
                            ],
...
$GLOBALS['Связи']    = [
    ...
    '2'  => [
        'Тип'                 => 'Глобальное',
        'Возможности'         => ['kill'=>'1.2.1'],
        'Приобретение'        => ['1.2.2.5'=>'result'],
        'Образец возможностей' => [
            'kill' => 'false',
        ],
        'Образец приобретения' => [
            'result' => 'Казнить нельзя, помиловать.',
        ],
        'Реакция'             => false
    ],
    '3'  => [
        'Тип'                 => 'Локальное',
        'Возможности'         => ['1.2.2.1'=>'one_text', '1.2.2.5'=>'all_text'],
        'Приобретение'        => ['all_text'=>'1.2.2.5'],
        'Образец возможностей' => [
            '1.2.2.1'=> 'Казнить',
            '1.2.2.5'=> null,
        ],
    ...
    '4'  => [
        'Тип'                 => 'Локальное',
        'Возможности'         => ['1.2.2.2'=>'one_text', '1.2.2.5'=>'all_text'],
        'Приобретение'        => ['all_text'=>'1.2.2.5'],
        'Образец возможностей' => [
            '1.2.2.2'=> 'нельзя',
            '1.2.2.5'=> 'Казнить',
        ...
        'Образец приобретения' => [
            '1.2.2.5' => 'Казнить нельзя',
        ],
        'Реакция'             => '3'
    ],
    '5'  => [
        'Тип'                 => 'Локальное',
        'Возможности'         => ['1.2.2.3'=>'one_text', '1.2.2.5'=>'all_text'],
        'Приобретение'        => ['all_text'=>'1.2.2.5'],
        'Образец возможностей' => [
            '1.2.2.3'=> 'помиловать.',
            '1.2.2.5'=> 'Казнить нельзя,',
        ...
        'Образец приобретения' => [
            '1.2.2.5' => 'Казнить нельзя, помиловать.',
        ],
        'Реакция'             => '3'
    ],
    '6'  => [
        'Тип'                 => 'Локальное',
        'Возможности'         => ['1.2.2.4'=>'one_text', '1.2.2.5'=>'all_text'],
        'Приобретение'        => ['all_text'=>'1.2.2.5'],
        'Образец возможностей' => [
            '1.2.2.4'=> ',',
            '1.2.2.5'=> 'Казнить',
...
$GLOBALS['Реакции']  = [
    ...
    '2'  => [
        'Способность'  => function($opportunities = []){
            ...
            /*результат*/
            return [
                'all_text' => $opportunities['all_text'].$opportunities['one_text'],
            ];
        }
    ],
    '3'  => [
